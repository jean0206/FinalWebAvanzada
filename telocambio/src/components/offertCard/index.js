    ...
    <View style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.actionsContainer}>
          ...
          {
            toggle?<TouchableOpacity onPress={getProps} style={styles.buttonView}>
            <Text style={styles.buttonText}>Ver oferta</Text>
          </TouchableOpacity>:<></>
          }
          {
            toggle?<></>:<TouchableOpacity style={[styles.buttonView,{backgroundColor:state==='Rechazada'?'#EB5757':'#27AE60'}]}>
